  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:8vw; height:7vh; padding-top:0px;" alt="Brand" src="asset/img/logofix.png">
      </a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right" >
      <li>
        <?php 
          $conn = mysqli_connect('localhost', 'root', '', 'kstyle');
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:8vw; height:8vh; padding-top:2vh;" alt="Brand" src="asset/img/logofix.png"></a>
    </div>
    <div class="col-xs-6">
