    ...
    <div class="col-xs-8 col-xs-offset-2">
      <div class="table-responsive">          
        <table class="table">
          <thead>
            <tr>
              <h3 style="font-family: abhayalibre-bold; color:black"><strong>K E R A N J A N G</strong></h3>
            </tr>
          </thead>
          <tbody>
          <?php 
            ...
            echo '
              <div class="">
                <div class="col-xs-5" style="background: #FFF0F5;height: 10vh; color:black; line-height:10vh;margin-left:18vw; border-radius:10px; text-align:center">
